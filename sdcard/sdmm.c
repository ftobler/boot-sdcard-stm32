...
#define DO			gpio_ll_read(GPIOC, SPI_MISO_Pin)	   /* Test for MMC DO ('H':true, 'L':false) */

#define DI_INIT()	/* Initialize port for MMC DI as output */
#define DI_H()		gpio_ll_set(GPIOD, SPI_MOSI_Pin)	/* Set MMC DI "high" */
#define DI_L()		gpio_ll_reset(GPIOD, SPI_MOSI_Pin)	/* Set MMC DI "low" */

#define CK_INIT()	/* Initialize port for MMC SCLK as output */
#define CK_H()		NOPN;gpio_ll_set(GPIOC, SPI_CLK_Pin);NOPN;	/* Set MMC SCLK "high" */
#define	CK_L()		NOPN;gpio_ll_reset(GPIOC, SPI_CLK_Pin);NOPN;	/* Set MMC SCLK "low" */

#define CS_INIT()	/* Initialize port for MMC CS as output */
#define	CS_H()		NOPN;gpio_ll_set(GPIOC, SPI_CS_Pin);NOPN;	/* Set MMC CS "high" */
#define CS_L()	    NOPN;gpio_ll_reset(GPIOC, SPI_CS_Pin);NOPN;	/* Set MMC CS "low" */
